#!/bin/bash
# ADAPTER_PORT VERSION PROJECT LOCATION DATASET STORE_NAME STORE_SCP_RUN_STEP STORE_SCP_PORT COMMITMENT_SCU_STEP COMMITMENT_SCU_PORT imageProject commitShortSha
